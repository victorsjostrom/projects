/*!/wp-content/plugins/bookly-responsive-appointment-booking-tool/backend/resources/js/daterangepicker.js*/
/**
*                            Patched
* @version: 3.0.5
...
this.alwaysShowCalendars=options.alwaysShowCalendars;if(options.locale!==undefined){moment.locale(moment.locale(),{months:options.locale.monthNames,monthsShort:options.locale.monthNamesShort,weekdays:options.locale.dayNames,weekdaysShort:options.locale.dayNamesShort,weekdaysMin:options.locale.dayNamesShort})}
